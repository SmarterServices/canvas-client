...
class CanvasClient {
  ...
  courseEnrollments(options) {
    ...
    return this
      ...
      .then(response => {
        ...
        let requestIterator = new CanvasRequestIterator(credentials);
      ...
      .then(results => {
        enrollments = results;
        return this._courseUsers(options);
      })
      .then(users => {
  ...
  _courseUsers(options) {
    ...
    return this
      ...
      .then(response => {
        ...
        const requestIterator = new CanvasRequestIterator(credentials);
   ...
   * @returns {Array}
   */
  listAccountExternalTools(options) {
